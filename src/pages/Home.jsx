                ...
                <div className='container'>
                    <div className='row'>
                        <div className='col-sm-6 d-flex d-sm-block flex-column align-items-center'>
                            ...
                            <h1 className='mb-5 text-black fw-bold text-center text-sm-start'>Our Restaurant_App</h1>
                            <MenuBtn />
                        </div>
                    </div>
                </div>
                ...
                <div className='row mb-5 w-100'>
                    <div className='col-lg-6 d-flex flex-column align-items-center mb-5 mb-lg-0'>
                        ...
                        <ul className='px-0'>
                            <li className='d-flex justify-content-between'>
                                ...
                                <p className='fs-3 mx-2 text-success fw-bold'>₹50</p>
                            </li>
                            <li className='d-flex justify-content-between'>
                                <p className='fs-3 mx-2'>Butter Chicken</p>
                                <p className='fs-3 mx-2 text-success fw-bold'>₹200</p>
                            </li>
                            <li className='d-flex justify-content-between'>
                    ...
                    <div className='col-lg-6 d-flex flex-column align-items-center mb-5 mb-lg-0'>
                        ...
                        <ul className='px-0'>
                            ...
                            <li className='d-flex justify-content-between'>
                                <p className='fs-3 mx-2'>Thandai</p>
                                <p className='fs-3 mx-2 text-success fw-bold'>₹25</p>
                            </li>
                        </ul>
                    </div>
                </div>
